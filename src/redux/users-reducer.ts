...
export const getUsersThunkCreator = (page: number, pageSize: number) => (dispatch: Dispatch<usersReducerActionType>) => {
...
export const followUnfollowFlow = async (dispatch: Dispatch<usersReducerActionType>,
                                   userId: number,
...
export const follow = (userId: number) => (dispatch: Dispatch<usersReducerActionType>) => {
...
export const unfollow = (userId: number) => (dispatch: Dispatch<usersReducerActionType>) => {
