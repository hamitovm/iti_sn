...
export type dialogsReducerActionType = UpdateNewMessageBody | SendMessage
...
export const dialogsReducer = (state: MessagesPageDataType = initialState, action: dialogsReducerActionType) => {
    switch (action.type) {
