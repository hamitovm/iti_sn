...
axios.get('https://google.com')
    ...
    .then((dataFromfirstThen)=> console.log(dataFromfirstThen))
    .catch((error) => {
        console.log(error)
    })
    .finally(() => {
...
let dataFromPromise = axios.get('https://google.com')
...
async function getData() {
    let dataFromPromise2 = await axios.get('https://google.com')
